# Claude Usage Analytics (Updated Fork)
...
>
> All credit for the original extension goes to Reid Havens. This fork adds Opus 4.6/Sonnet 4.6 model support, fixes pricing calculations, and populates previously empty dashboard sections (personality, request types, daily costs). See [CHANGES.md](CHANGES.md) for full details.

![Version](https://img.shields.io/badge/version-1.1.8--patched-blue)
...
> **Original extension inspired by [Claude Goblin](https://github.com/data-goblin/claude-goblin)** by [Kurt Buhler](https://github.com/data-goblin) - A brilliant tool for analyzing Claude usage data. Kurt's innovative approach to persisting usage history beyond Claude Code's rolling 30-day window inspired the original extension. Check out his work!
...
![Status Bar with Tooltip](https://github.com/analyticendeavors/claude-usage-analytics/raw/HEAD/screenshots/status%20bar%20and%20tooltip.png)

<details>
<summary><b>View Dashboard Screenshots</b></summary>

### Overview
![Overview Report](https://github.com/analyticendeavors/claude-usage-analytics/raw/HEAD/screenshots/overview%20report.png)

### Cost Analysis
![Cost Report](https://github.com/analyticendeavors/claude-usage-analytics/raw/HEAD/screenshots/cost%20report.png)

### Messages
![Messages Report](https://github.com/analyticendeavors/claude-usage-analytics/raw/HEAD/screenshots/messages%20report.png)

### Personality
![Personality Report](https://github.com/analyticendeavors/claude-usage-analytics/raw/HEAD/screenshots/personality%20report.png)
...
See [BACKFILL_GUIDE.md](https://github.com/analyticendeavors/claude-usage-analytics/blob/HEAD/BACKFILL_GUIDE.md) for detailed instructions.
...
MIT License with Commons Clause — see [LICENSE](https://github.com/analyticendeavors/claude-usage-analytics/blob/HEAD/LICENSE) for details.
